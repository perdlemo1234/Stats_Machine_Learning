...
```{r my_lm}
pets <- read.csv("C:/Users/tanwe/OneDrive - University of Bristol/[ Year 3 ]/Spring Lecture Notes/Statistical Machine Learning/CW/pets.csv")
...
I changed all Prod terms to NTT and adjusted all axis labels in my diagrams.
